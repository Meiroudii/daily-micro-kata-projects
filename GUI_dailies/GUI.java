import javax.swing.*;
public class GUI { private static void AnotherFockinGUI() {
...
frame.getContentPane().add(label, poem); frame.pack();
frame.setVisible(true);} private static void DeathThreat() {
...
public static void main(String[] args) {
  javax.swing.SwingUtilities.invokeLater(new Runnable() {
    public void run() {AnotherFockinGUI();}
    });
  }
}
